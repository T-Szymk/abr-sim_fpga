...
# Date     : 22-may-2026
#
# Description: Vivado build script to generate a netlist for ABR
#              using the OOC flow
# ------------------------------------------------------------------------------
...
set FPGA_SV_FILES " \
  ...
  ${FPGA_SRC_DIR}/abr_mem_if_unpack.sv \
...
set_property PROCESSING_ORDER LATE [get_files ${CONSTR}]
set_property USED_IN {synthesis implementation out_of_context} [get_files ${CONSTR}]
